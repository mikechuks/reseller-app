        ...
        <div class="container-fluid px-3 px-lg-4 py-4">
          ...
          <section class="panel">
            ...
            <?php foreach($images as $image): ?>
              <tr>
                <td>   <?php echo htmlspecialchars($image->product->name ?? 'No Product'); ?></td>
                <td> <img src="<?php echo asset('storage/' . $image->image); ?>" width="80" height="80" style="object-fit:cover;border-radius:5px;">
                </td>
                <td><?php echo htmlspecialchars($image->created_at); ?></td>
                <td><?php echo htmlspecialchars($image->updated_at); ?></td>
                <td class="text-end"><a class="btn btn-light btn-sm" href="<?php echo route('productImg.edit', $image->id); ?>" type="button">Edit</a>
                  <form action="<?php echo route('productImg.destroy', $image->id); ?>" method="POST" style="display:inline;">
