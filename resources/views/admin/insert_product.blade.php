        ...
        <div class="container-fluid px-3 px-lg-4 py-4">
          ...
          <section class="row">
            <div class="col-12 col-xl-12">
              <form class="panel needs-validation" action="<?php echo route('product.store'); ?>" method="POST" novalidate>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" id="formPrice" type="number" step="0.01" name="price" placeholder="Price" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" id="formBudget" type="number" name="stock" placeholder="Stock" required>
                        <div class="invalid-feedback">Enter a valid Stock.</div>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label" for="formBudget">SKU</label>
                        <input class="form-control" id="formBudget" type="text" name="sku" placeholder="SKU" required>
                    ...
                    <textarea class="form-control" id="formMessage" rows="5"         name="description" required></textarea>
